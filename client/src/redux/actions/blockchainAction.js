    ...
    dispatch({type:CONNECTION_REQUEST})
        if(window.ethereum){
            ...
            try {
                ...
                const contract_MM =new web3.eth.Contract(abi,'0x2057Ee7b3cd3844cA6b3040482fC3Aa354184005')
             ...
             //  const contract_Infura = new web3_infura.eth.Contract()
                ...
                toast.warn('Login your Metamask ')
            }
        }else{
            dispatch({
                type:CONNECTION_FAILED,
...
//Voting address :0xdd1e92203905a316e918Bb2cBab0E3486a07E183
